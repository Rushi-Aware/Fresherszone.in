...
//Import images
import featureImage from "../../../assets/images/featured-job/Globalion_Logo.png";
        ...
        <Card className="side-bar">
          <CardBody className="p-4">
            <div className="candidate-profile text-center">
              ...
              />
              <h6 className="fs-18 mb-1 mt-4">Globalion Technology Solutions Pvt.Ltd</h6>
          ...
          <CardBody className="candidate-profile-overview border-top p-4">
            ...
            <ul className="list-unstyled mb-0">
              <li>
                <div className="d-flex">
                  ...
                  <div>
                    <p className="text-muted mb-0">Vikas Kasture</p>
                  </div>
                </div>
              </li>
              <li>
            ...
            <div className="mt-3">
              <Link to="#" className="btn btn-success btn-hover w-100">
            ...
            <div className="ur-detail-wrap">
              ...
              <div className="ur-detail-wrap-body">
                <ul className="working-days">
                  ...
                  <li>
                    Saturday<span className="text-danger">Close</span>
                  </li>
                  <li>
