...
const CandidateDetails = () => {
  const candidateDetails = [
    ...
    },
    {
      id: 5,
      userImg: userImage5,
      candidateName: "Aditi Dumbre",
      candidateDesignation: "React Developers",
      location: "Pune-Maharashtra",
      salary: "675 / hours",
      rating: 4.9,
      ratingClass: "badge bg-success ms-1",
