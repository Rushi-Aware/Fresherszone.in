        ...
        <Card className="side-bar">
          <CardBody className="p-4">
            <div className="candidate-profile text-center">
              ...
              />
              <h6 className="fs-18 mb-0 mt-4">Yukta Bhujabal</h6>
            ...
            <ul className="list-unstyled mb-0">
              ...
              <li>
                <div className="d-flex">
                  ...
                  <div>
                    <p className="text-muted mb-0">650 per hour</p>
                  </div>
                </div>
              </li>
              <li>
              ...
              <li>
                <div className="d-flex align-items-center mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">yukta@gmail.com</p>
                  </div>
                </div>
              </li>
              <li>
                <div className="d-flex align-items-center mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">Dodge City, Pune</p>
                  </div>
                </div>
              </li>
              <li>
                <div className="d-flex align-items-center mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">+91(952) 125-6789</p>
                  </div>
                </div>
              </li>
              <li>
                <div className="d-flex align-items-center mt-4">
                  ...
                  <div className="ms-3">
                    ...
                    <p className="text-muted mb-0">@ybhujabal</p>
                  </div>
                </div>
              </li>
            </ul>
